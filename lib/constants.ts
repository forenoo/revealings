export const navLinksIndonesia = [
  {
    id: 1,
    name: "Beranda",
    href: "#home",
  ...
  image: [
    {
      ...
      description:
        "Pesisir pantai Raja Ampat adalah surga tropis dengan pasir putih, air jernih, dan panorama karang yang menakjubkan.",
      image: "/image-1.jpg",
    },
    {
      title: "Keindahan Tersembunyi di Raja Ampat",
      description:
        "Tersembunyi di antara tebing karst yang megah, laguna hijau toska di Raja Ampat ini memancarkan ketenangan dan pesona alam yang tak tertandingi.",
      image: "/image-2.jpg",
    },
    {
      title: "Terumbu Karang Raja Ampat",
      description:
        "Menyelami perairan Raja Ampat memperlihatkan dunia bawah laut yang penuh keajaiban, seperti terumbu karang berwarna cerah ini",
      image: "/image-3.jpg",
    },
    {
      title: "Kepulauan Raja Ampat",
      description:
        "Deretan pulau-pulau kecil yang hijau membentuk pemandangan luar biasa di Raja Ampat, dengan perairan biru kehijauan",
      image: "/image-4.jpg",
    },
    {
      title: "Dermaga Surga di Raja Ampat",
      description:
  ...
  image: [
    {
      title: "Coastal Shore",
      description:
        "Raja Ampat's coastline is a tropical paradise of white sand, clear water and stunning coral panoramas.",
      image: "/image-1.jpg",
    },
    {
      title: "Hidden Beauty in Raja Ampat",
      description:
        "Hidden amongst majestic karst cliffs, this turquoise green lagoon in Raja Ampat exudes tranquility and unparalleled natural charm. ",
      image: "/image-2.jpg",
    },
    {
      title: "Raja Ampat's Coral Reefs",
      description:
        "Diving into the waters of Raja Ampat reveals an underwater world full of wonders, like these brightly colored coral reefs",
      image: "/image-3.jpg",
    },
    {
      title: "Stunning Islands of Raja Ampat",
      description:
        "Rows of small green islands form a magnificent landscape in Raja Ampat, with turquoise waters sparkling in the sunlight.",
      image: "/image-4.jpg",
    },
    {
      title: "The Paradise Pier in Raja Ampat",
      description:
        "The clear sky with scattered white clouds added to the beauty of the scene. In the distance, green hills and mountains can be seen silhouetted against the horizon line, creating a dramatic backdrop.",
      image: "/image-5.jpg",
    },
  ],
};

export const aboutUsIndonesia = {
...
export const benefitEnglish = {
  ...
  benefit: [
    ...
    {
      id: 2,
      title: "Tour Guide to Walk through Raja Ampat",
      description:
...
export const destinationIndonesia = {
...
export const trustedIndonesia = {
  title: "Dipercaya Berbagai Penyedia Layanan Pariwisata",
};

export const trustedEnglish = {
  title: "Trusted By Many Travel Services",
};

export const ratingIndonesia = {
